      ...
      >
        <div className="text-center">
          <h1 className="text-3xl font-black text-white tracking-tight flex items-center justify-center gap-2 mb-1">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-teal-300">Register</span>
          </h1>
          <p className="text-xs text-slate-400">Join the Cloud Native CAD Platform</p>
        </div>
        ...
        <p className="text-xs text-center text-slate-400 mt-2">
          ...
          <a href="/login" className="text-indigo-400 hover:text-indigo-300 font-bold transition-colors">
            Log in here
          </a>
        </p>
      </form>
